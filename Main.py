...
#         if int(month) == 10:
#             if idx >= 14: # TODO use dates rather than indexing
...
# while startDate <= datetime(2021, 10, 15):
...
timeDelta = timedelta()
nprPlaylistCreator = NPRPlaylistCreator()
nprPlaylistCreator.ChangePlaylistToPublic(startDate, datetime(2021, 10, 15), timedelta)