...
# startDate = datetime(2021, 7, 14)
# timeDelta = timedelta()
# nprPlaylistCreator = NPRPlaylistCreator()
# nprPlaylistCreator.ChangePlaylistToPublic(startDate, datetime(2021, 7, 21), timedelta)

# # Used to parse a range of dates, load the json for those days, and make playlists on spotify
# startDate = datetime(2021, 7, 14) # check 9 to 3, 28 for missing track playlists
# projectName = "MoWeEd"
