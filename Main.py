...
#         if int(month) == 10:
#             if idx >= 27: # TODO use dates rather than indexing
...
# while startDate <= datetime(2021, 11, 1):
...
timeDelta = timedelta()
nprPlaylistCreator = NPRPlaylistCreator()
nprPlaylistCreator.ChangePlaylistToPublic(startDate, datetime(2021, 11, 1), timedelta)