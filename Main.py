...
#         if int(month) == 11:
#             if idx >= 20: # TODO use dates rather than indexing
...
# while startDate <= datetime(2021, 11, 21):
...
# startDate = datetime(2021, 11, 2)
# timeDelta = timedelta()
# nprPlaylistCreator = NPRPlaylistCreator()
# nprPlaylistCreator.ChangePlaylistToPublic(startDate, datetime(2021, 11, 21), timedelta)