...
#         if int(month) == 10:
#             if idx >= 26: # TODO use dates rather than indexing
...
# while startDate <= datetime(2021, 10, 27):
...
timeDelta = timedelta()
nprPlaylistCreator = NPRPlaylistCreator()
nprPlaylistCreator.ChangePlaylistToPublic(startDate, datetime(2021, 10, 27), timedelta)