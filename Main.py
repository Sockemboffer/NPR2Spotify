...
#         if int(month) == 10:
#             if idx >= 13: # TODO use dates rather than indexing
...
# while startDate <= datetime(2021, 10, 14):
...
# timeDelta = timedelta()
# nprPlaylistCreator = NPRPlaylistCreator()
# nprPlaylistCreator.ChangePlaylistToPublic(startDate, datetime(2021, 10, 14), timedelta)