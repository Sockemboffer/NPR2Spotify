...
if response_json["tracks"]["total"] == 0:
    ...
    query = "https://api.spotify.com/v1/search?q={}&type=track%2Cartist&market=US&limit=5".format(parse.quote('track:' + '"' + trackNoBrackets + '"' + ' ' + 'artist:"' + artists[0] + '"'))
...
if response_json["tracks"]["total"] == 0:
    ...
    query = "https://api.spotify.com/v1/search?q={}&type=track%2Cartist&market=US&limit=5".format(parse.quote('"' + trackNoBracketsAndBraces + '"' + ' ' + 'artist:"' + artists[0] + '"'))
...
if response_json["tracks"]["total"] == 0:
    ...
    query = "https://api.spotify.com/v1/search?q={}&type=track%2Cartist&market=US&limit=5".format(parse.quote('"' + self.result + '"' + ' ' + 'artist:"' + artists[0] + '"'))
